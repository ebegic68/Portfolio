...
void Autoprodaja::unos_Auta(){
 ...
 std::cin>>br_sasije;
 std::cout<<"Kolika je cijena vaseg vozila? "<<std::endl;
 std::cin>>cijena_auta;
 std::cout<<"Koje je godiste automobil? "<<std::endl;
 std::cin>>godiste_auta;
 std::cout<<"Kolika je kilometrasa vozila? "<<std::endl;
 std::cin>>kilometraza;
...
std::cout<<"Broj sasije: "<<br_sasije<<std::endl;
std::cout<<"Cijena auta: "<<cijena_auta<<std::endl;
std::cout<<"Godiste auta: "<<godiste_auta<<std::endl;
std::cout<<"Kilometrasa auta: "<<kilometraza<<std::endl;
    ...
    do{
        ...
        std::cout<<"Opcija 1: Dodaj"<<std::endl;
         ...
         case 3:
            {
                ...
                long int broj;
                std::cout<<"Unesi broj sasije auta: ";
                std::cin>>broj;
                ...
                if(provjera==false){
                    std::cout<<"Broj sasije ne postoji!"<<std::endl;
                }
                treca.close();
                break;
                }
         ...
         case 6:
            {
                std::cin.clear();
                std::cout<<"HVALA STO SE KORISTI AUTOPRODAJNI SISTEM"<<std::endl;
                break;
            }
